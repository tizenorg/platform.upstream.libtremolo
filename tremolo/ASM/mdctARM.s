	...
	.global mdct_shift_right_tremolo
	.global mdct_unroll_prelap_tremolo
	.global mdct_unroll_part2_tremolo
	.global mdct_unroll_part3_tremolo
	.global mdct_unroll_postlap_tremolo

mdct_unroll_prelap_tremolo:
	@ r0 = out
	@ r1 = post
	@ r2 = r
	@ r3 = step
...
mdct_butterflies_loop2:
	...
	@ mdct_butterfly_generic_tremolo(x+POINTS*j, POINTS, 4<<(i+shift))
	@ mdct_butterfly_generic_tremolo(r1, r0, r6)
	@ r0 = points
	@ r1 = x
...
mdct_bufferfly_generic_loop2:
	...
	LDMFD	r13,{r0-r1}
no_generics:
	@ mdct_butterflies_tremolo part2 (loop around mdct_bufferfly_32)
	@ r0 = points
	@ r1 = in
	@ r2 = step
	@ r3 = shift
