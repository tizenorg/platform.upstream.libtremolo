	...
	.global	decode_packed_entry_number_tremolo
	.global decode_packed_entry_number_REALSTART
	.global decode_map_tremolo
	.global vorbis_book_decodevv_add_tremolo
	.global _checksum_tremolo

decode_packed_entry_number_REALSTART:
dpen_nobits:
	MOV	r0,r5		@ r0 = b
	MOV	r1,#1		@ r1 = 1
	BL	oggpack_adv_tremolo	@ oggpack_adv_tremolo(b,1)      /* Force eop */
duff:
	MVN	r0,#0		@ return -1
...
m0_loop:
	...
	MOV	r0, r5			@ r0 = b
	BL	oggpack_adv_tremolo		@ oggpack_adv_tremolo(b, i+1);
...
m1_loop:
	...
	MOV	r0, r5			@ r0 = b
	BL	oggpack_adv_tremolo		@ oggpack_adv_tremolo(b, i)
...
decode_map_tremolo:
	...
	MOV	r6, r2		@ r6 = v
	MOV	r7, r3		@ r7 = point
	BL	decode_packed_entry_number_tremolo
	MOV	r8, r0

	MOV	r0, r5
	BL	oggpack_eop_tremolo
	CMP	r0, #0
	BNE	dm_duff
