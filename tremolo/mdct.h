...
extern void mdct_backward_tremolo(int n, DATA_TYPE *in);
extern void mdct_shift_right_tremolo(int n, DATA_TYPE *in, DATA_TYPE *right);
extern void mdct_unroll_lap_tremolo(int n0,int n1,
			    int lW,int W,
