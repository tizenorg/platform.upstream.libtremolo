...
extern vorbis_info_floor *floor0_info_unpack_tremolo(vorbis_info *,oggpack_buffer *);
extern void floor0_free_info_tremolo(vorbis_info_floor *);
extern int floor0_memosize_tremolo(vorbis_info_floor *);
extern ogg_int32_t *floor0_inverse1_tremolo(struct vorbis_dsp_state *,
				    vorbis_info_floor *,ogg_int32_t *);
extern int floor0_inverse2_tremolo (struct vorbis_dsp_state *,vorbis_info_floor *,
			    ogg_int32_t *buffer,ogg_int32_t *);

extern vorbis_info_floor *floor1_info_unpack_tremolo(vorbis_info *,oggpack_buffer *);
extern void floor1_free_info_tremolo(vorbis_info_floor *);
extern int floor1_memosize_tremolo(vorbis_info_floor *);
extern ogg_int32_t *floor1_inverse1_tremolo(struct vorbis_dsp_state *,
				    vorbis_info_floor *,ogg_int32_t *);
extern int floor1_inverse2_tremolo (struct vorbis_dsp_state *,vorbis_info_floor *,
			    ogg_int32_t *buffer,ogg_int32_t *);
...
extern void res_clear_info_tremolo(vorbis_info_residue *info);
extern int res_unpack_tremolo(vorbis_info_residue *info,
		      vorbis_info *vi,oggpack_buffer *opb);
extern int res_inverse_tremolo(vorbis_dsp_state *,vorbis_info_residue *info,
...
extern int mapping_info_unpack_tremolo(vorbis_info_mapping *,vorbis_info *,
			       oggpack_buffer *);
extern void mapping_clear_info_tremolo(vorbis_info_mapping *);
extern int mapping_inverse_tremolo(struct vorbis_dsp_state *,vorbis_info_mapping *);
...
extern int      vorbis_dsp_headerin_tremolo(vorbis_info *vi,vorbis_comment *vc,
				    ogg_packet *op);
